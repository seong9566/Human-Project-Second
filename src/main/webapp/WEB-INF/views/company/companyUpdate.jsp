				...
				<div class="card card-registration card-registration-2"
					...
					<div class="card-body p-0">
						<div class="row g-0">
							<div class="col-lg-6">
								<div class="p-5">
									<h3 class="fw-normal mb-5" style="color: #4835d4;">기업 회원
										정보 수정</h3>
									<div>
									...
									<div class="row">
										<div class="mb-3">
											회사 이름 <input id="companyName" type="text"
												class="form-control" placeholder="회사 이름을 입력해주세요"
												style="margin-bottom: 20px;"
												value="${companyInfo. companyName}"> 이메일<input
												id="companyEmail" type="email" class="form-control"
											...
											<input id="zoneCode" type="text" value="${address.zoneCode }"
												readonly> <br> <input id="roadJibunAddr"
												type="text" value="${address.roadJibunAddr}"
												style="width: 500px;" readonly> <input
												type="detailAddress" value="${address.detailAddress }"
