									...
									<div class="row">
										<div class="mb-3 mt-3">
											...
											<button id="btnUsernameSameCheck" class="btn btn-warning"
												type="button"
												style="background-color: red; color: white; border: none; margin-bottom: 10px; margin-top: 10px; margin-bottom: 20px;">아이디
												중복체크</button>
										</div>
									...
									<div class="row">
										<div class="mb-3">
											...
											<input id="addr" type="text" class="form-control"
												...
												class="form-control" id="detail_address" type="text"
												placeholder="상세주소"><br />
											<div class="mb-3">
