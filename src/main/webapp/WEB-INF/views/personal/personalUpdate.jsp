                    ...
                    <div class="card card-registration card-registration-2" style="border-radius: 15px;">
                        <div class="card-body p-0">
                            <div class="row g-0">
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        <h3 class="fw-normal mb-5" style="color: #4835d4;">개인회원 정보수정</h3>
                                        <div class="row">
                                            <div class="mb-3 mt-3">
                                                아이디 <input id="userId" type="text" class="form-control"
                                                    value="${personalUpdateForm.loginId}" placeholder="아이디를 입력해주세요." readonly
                                        ...
                                        <div class="mb-3">
                                            비밀번호<input id="password" type="password" class="form-control"
                                                value="${personalUpdateForm.loginPassword}" placeholder="비밀번호를 입력해주세요"
                                                style="margin-bottom: 20px;">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label> <input type="radio" name="contact" value="highschool" checked />
                                                <span>고졸</span>
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <label> <input type="radio" name="contact" value="2년제 졸업" /> <span>2년제 대학
                                                    졸업</span>
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <label> <input type="radio" name="contact" value="4년제 졸업" /> <span>4년제 대학
                                                    졸업</span>
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <label> <input type="radio" name="contact" value="재학 중" /> <span>대학
                                                    재학중</span>
                                            </label>
                                        </div>
                                        <br />
                                        <div class="mb-3">
                                            이름 <input id="username" type="text" class="form-control"
                                                value="${personalUpdateForm.personalName}" placeholder="이름을 입력해주세요"
                                                style="margin-bottom: 20px;">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="mb-3">
                                                ...
                                                <input id="post" type="text" class="form-control" placeholder="우편번호"
                                                    value="${personalAddress.zoneCode}" readonly onclick="findAddr()">
                                                <br /><input id="addr" type="text" class="form-control" placeholder="주소"
                                                    value="${personalAddress.roadJibunAddr}" readonly><br />
                                                <input class="form-control" id="detail_address" type="text"
                                                    value="${personalAddress.detailAddress}" placeholder="상세주소"><br />
                                                <div class="mb-3">
