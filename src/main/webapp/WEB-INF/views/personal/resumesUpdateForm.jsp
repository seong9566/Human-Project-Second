<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	<%@ include file="../layout/header.jsp" %>
		...
		<input id="resumesId" type="hidden" value="${resumesDetailDtoPS.resumesId}">
		<input id="resumesCategoryId" type="hidden" value="${resumesDetailDtoPS.resumesCategoryId}">
		<input id="careerId" type="hidden" value="${resumesDetailDtoPS.careerId}">
		<input id="portfolioId" type="hidden" value="${resumesDetailDtoPS.portfolioId}">
		<input id="resumesId" type="hidden" value="${resumesDetailDtoPS.resumesId}">
		<input id="resumesCategoryId" type="hidden" value="${resumesDetailDtoPS.resumesCategoryId}">
		<input id="careerId" type="hidden" value="${resumesDetailDtoPS.careerId}">
		<input id="portfolioId" type="hidden" value="${resumesDetailDtoPS.portfolioId}">
						...
						<div class="card card-registration card-registration-2" style="border-radius: 15px;">
							<div class="card-body p-0">
								<div class="row g-0" style="margin-left: 30px;">
									<div class="col-lg-6">
										<div class="p-5">
											<h3 class="fw-normal mb-5" style="color: #4835d4;">이력서 수정
												페이지</h3>
											<div class="left_input">
												...
												<input id="usersName" type="text" class="form-control"
													style="width: 300px"
													placeholder="${resumesDetailDtoPS.personalName}" readonly>
												<br />
												<p style="font-size: 15px;">번호</p>
												<input id="phoneNumber" type="text" class="form-control"
													style="width: 300px"
													placeholder="${resumesDetailDtoPS.personalPhoneNumber}" readonly>
												<br />
												<p style="font-size: 15px;">이메일</p>
												<input id="email" type="text" class="form-control" style="width: 300px"
													placeholder="${resumesDetailDtoPS.personalEmail}" readonly>
												<p style="font-size: 15px;">학력</p>
												<input id="education" type="text" class="form-control"
													style="width: 300px"
													placeholder="${resumesDetailDtoPS.personalEducation}" readonly>
											</div>
										</div>
									</div>
																	...
																	<div class="form-check d-flex">
																		...
																		<div class="form-check">
																			<label for="fourth"><input type="radio"
																					...
																					style="margin-right: 15px;">5년이상</label>
																		</div>
																	</div>
																</td>
															</tr>
														...
														<div style="margin-left: 77px">
															<tr>
																<td><label><input type="checkbox" name="interest"
																			value="categoryFrontend">frontend</label>
																	<label><input type="checkbox" name="interest"
																			value="categoryBackend">backend</label>
																	<label><input type="checkbox" name="interest"
																			value="categoryDevops">devops</label>
																	<label><input id="etc" type="checkbox"
																			name="interest" value="etc">etc</label>
																</td>
															</tr>
														</div>
													</div>
								...
								<div class="form-group" style="justify-content: center;">
									...
									<input id="resumesTitle" type="text" class="form-control"
										placeholder="이력서 제목을 입력해주세요." value="${resumesDetailDtoPS.resumesTitle}"
										style="width: 950px; margin-left: 100px">
									<textarea class="form-control" id="resumesIntroduce" rows="8"
										style="margin-bottom: 10px; width: 950px; margin-left: 100px">${resumesDetailDtoPS.resumesIntroduce}</textarea>
								</div>
