                                        ...
                                        <div class="p-5">
                                            ...
                                            <div class="row">
                                                <div class="mb-3 mt-3">
                                                    ...
                                                    <button id="btnUsernameSameCheck"
                                                        class="btn btn-warning"
                                                        style=" color: white; background-color: rgba(0, 195, 98, 255); border: none; margin-bottom: 10px; margin-top: 10px; margin-bottom: 20px;"
                                            ...
                                            <div class="form-check form-check-inline">
                                                <label> <input type="radio" name="contact" value="2년제 졸업" /> <span>2년제
                                                        대학
                                                        졸업</span>
                                                </label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <label> <input type="radio" name="contact" value="4년제 졸업" /> <span>4년제
                                                        대학
                                                        졸업</span>
                                                </label>
                                            </div>
                                        ...
                                        <div class="p-5">
                                            <div class="row">
                                                <div class="mb-3">
                                                    ...
                                                    <br /><input id="addr" type="text" class="form-control"
