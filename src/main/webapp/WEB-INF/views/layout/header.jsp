                        ...
                        <ul class="navbar-nav" style="width: 100%">
                           <c:choose>
                              ...
                              <c:when test="${principal.companyId != null}">
                                 <ul>
                                    <li class="nav-link"><a href="/recommendList" style="color: black;">관심 이력서 보기</a>
                                    </li>
                                    <li class="nav-link"><a href="/company/jobPostingBoardList" style="color: black;">
                                          공고관리</a></li>
                                    <li class="nav-link"><a href="/company/companyInform" style="color: black;">기업정보</a>
                                    </li>
                                    <li class="nav-link"><a href="/logout" onclick="disconnect()"
                                          style="color: black;">로그아웃</a></li>
                                    <li class="nav-link" style="color: black;">${principal.userinfo.companyName}님환영합니다.
                                    </li>
                              ...
                              <c:otherwise>
                                 <ul>
                                    <li class="nav-link"><a href="/personal/personalInfo" style="color: black;">내정보</a>
                                    </li>
                                    <li class="nav-link"><a href="/personal/resumesForm"
                                          style="color: black;">이력서작성하기</a></li>
                                    <li class="nav-link"><a href="/personal/resumesList"
                                          style="color: black;">내이력서목록보기</a></li>
                                    <li class="nav-link"><a href="/logout" style="color: black;">로그아웃</a></li>
                                    <li class="nav-link" style="color: black;">${principal.userinfo.personalName}님
                                       환영합니다.</li>
                                    <li class="nav-link fa-regular fa-bell fa-xl" data-bs-toggle="modal"
                                       data-bs-target="#myModal" id="alarm" onclick="iconchangToRead()"></li>
                                    <li style="display: none;" id="userId" value="${principal.usersId}"></li>
